...
$sender = "Test Support"; // ชื่อผู้ส่ง
$email_sender = "jpguncom.1992@gmail.com"; // เมล์ผู้ส่ง 
$email_receiver = "guncom.1992@gmail.com"; // เมล์ผู้รับ ***
...
sendmai($sender , $email_sender , $email_receiver , $g_user , $g_pass , $subject , $email_content );
