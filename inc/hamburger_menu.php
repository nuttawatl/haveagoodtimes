	...
	<div class="menu">
		...
		<div class="menu_content">
			<ul>
				...
				<li><a href="../service/"           <?php if($active == "3") {?> style="color:#b5b508 ;" <?php } ?>>การบริการ</a></li>
				...
				<li><a href="../home/login.php" <?php if($active == "6") {?> style="color:#b5b508 ;" <?php } ?>>เข้าสู่ระบบ</a></li>
				<?php 
				}
				else{ ?>
